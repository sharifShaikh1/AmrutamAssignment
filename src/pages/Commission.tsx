      ...
      <div className="min-h-screen bg-[#F8F9FA] p-6 lg:p-8 font-sans text-slate-800">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 text-sm text-slate-500 mb-6">
            ...
            <span 
              className="cursor-pointer hover:text-[#3A643B] transition-colors"
              onClick={() => setView('list')}
            >
              Commission
            </span>
            <ChevronRight size={16} />
            <span className="text-[#3A643B] font-medium">Special Commission</span>
          </div>

          <h2 className="text-xl font-bold text-slate-800 mb-6">Add Special Commission</h2>

          {/* Form Container */}
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 min-h-[400px] flex flex-col justify-between">
            ...
            <div className="flex justify-end mt-12">
              <button 
                className="bg-[#3A643B] text-white px-12 py-3 rounded-xl font-bold text-sm hover:bg-[#2d502e] transition-all shadow-sm hover:shadow"
                onClick={() => setView('list')}
              >
                Add
              </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Header Section */}
          ...
          <div className="flex items-center gap-2 text-sm text-slate-500">
            <span>Affiliate</span>
            <ChevronRight size={16} />
            <span className="text-[#3A643B] font-medium">Commission</span>
          </div>
